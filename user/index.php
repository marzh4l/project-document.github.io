...
<html lang="en">
  <head>
	...
	<!-- iCheck -->
	<link href="../assets/vendors-adm/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	<!-- bootstrap-wysiwyg -->
	<link href="../assets/vendors-adm/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
	<!-- Select2 -->
	...
	<!-- Switchery -->
	<link href="../assets/vendors-adm/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
	<!-- starrr -->
	<link href="../assets/vendors-adm/vendors/starrr/dist/starrr.css" rel="stylesheet">
...
<body class="nav-md">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<?php 
								...
								while($d = mysqli_fetch_array($queryImg)){
							?>
							<img src="profile/<?php echo $d['avatar']=='' ? 'avatar0.jpg' : ''.$d['avatar'].''; ?>" alt="..." class="img-circle profile_img">
							<?php } ?>
						</div>
	...
	<!-- jQuery -->
	<script src="../assets/vendors-adm/jquery/dist/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script src="../assets/vendors-adm/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
	<!-- FastClick -->
    ...
    <!-- Flot -->
    <script src="../assets/vendors-adm/Flot/jquery.flot.js"></script>
    <script src="../assets/vendors-adm/Flot/jquery.flot.pie.js"></script>
    <script src="../assets/vendors-adm/Flot/jquery.flot.time.js"></script>
    <script src="../assets/vendors-adm/Flot/jquery.flot.stack.js"></script>
    <script src="../assets/vendors-adm/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="../assets/vendors-adm/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="../assets/vendors-adm/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="../assets/vendors-adm/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
	...
	<!-- Autosize -->
	<script src="..assets//vendor-vendors-adms/autosize/dist/autosize.min.js"></script>
	<!-- jQuery autocomplete -->
