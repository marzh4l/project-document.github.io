                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12">
						  <div class="x_panel">
                                <?php
                                    $id = $_GET['id_document'];
                                    $query = mysqli_query($conn,"SELECT `id_document`, `nm_document`, `no_surat`, `deskripsi`, `id_kategori`, `id_akses`, `id_unit`, `tanggal`, `status`, `file_pdf`, `penandatangan` FROM `documen` WHERE id_document = $id");
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="no_surat"  required="required" class="form-control " value="<?php echo $dataDocument['no_surat'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="item form-group">
